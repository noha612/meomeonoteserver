package nhom7.thh.meomeonoteserver.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "mainEntityManagerFactory",
        ...
        "nhom7.thh.meomeonoteserver.repository"})
public class DefaultDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return builder.dataSource(dataSource).packages("nhom7.thh.meomeonoteserver.entity")
